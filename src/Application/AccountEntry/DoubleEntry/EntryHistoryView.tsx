    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="p-3 bg-primary/10 rounded-lg border border-primary/20">
          <p className="text-xs text-primary font-medium">Narration</p>
          <p className="text-sm text-primary font-medium mt-0.5">{entry.narration}</p>
        </div>
          ...
          <Table>
            ...
            <TableBody>
              ...
              <TableRow className="bg-muted/40 border-t-2">
                <TableCell />
                <TableCell colSpan={3} className="text-xs font-semibold text-muted-foreground">TOTAL</TableCell>
                <TableCell className="text-right">
                  <span className="text-sm font-bold text-foreground">{formatINR(entry.total_debit)}</span>
                </TableCell>
                <TableCell className="text-right">
                  <span className="text-sm font-bold text-foreground">{formatINR(entry.total_credit)}</span>
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
